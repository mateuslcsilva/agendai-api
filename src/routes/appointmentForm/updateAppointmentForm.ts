...
export const updateAppointmentForm = async ( app: FastifyInstance) => {
    app.post('/updateAppointmentForm', (request: FastifyRequest<{ Body: SaveAppointmentForm }>, response: FastifyReply) => {
